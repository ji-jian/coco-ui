...
const q = { class: 'coco-markdown-body' },
  B = t('h1', null, 'Input \u8F93\u5165\u6846', -1),
  N = t('h2', null, '\u57FA\u672C\u4F7F\u7528', -1),
  C = t('p', null, '\u8F93\u5165\u6846\u7684\u57FA\u672C\u7528\u6CD5', -1),
  D = [B, N, C],
  E = {
    setup(m, { expose: l }) {
      return l({ frontmatter: {} }), (a, u) => (i(), c('div', q, D))
    }
  },
...
`
  ...
  M = {
    setup(m, { expose: l }) {
      return l({ frontmatter: {} }), (a, u) => (i(), c('div', F, L))
    }
  },
...
`
  ...
  J = {
    setup(m, { expose: l }) {
      return l({ frontmatter: {} }), (a, u) => (i(), c('div', Q, H))
    }
  },
  K = { class: 'coco-markdown-body' },
  O = t(
    'pre',
    null,
    [
...
`
  ...
  Y = {
    setup(m, { expose: l }) {
      return l({ frontmatter: {} }), (a, u) => (i(), c('div', K, X))
    }
  },
...
`
  ...
  lt = {
    setup(m, { expose: l }) {
      return l({ frontmatter: {} }), (a, u) => (i(), c('div', Z, ot))
    }
  },
  dt = { class: 'coco-markdown-body' },
  st = t(
    'pre',
    null,
    [
...
`
  ...
  it = {
    setup(m, { expose: l }) {
      return l({ frontmatter: {} }), (a, u) => (i(), c('div', dt, ut))
    }
  },
  ct = { class: 'coco-markdown-body' },
  mt = t(
    'pre',
    null,
    [
...
`
  ...
  ft = {
    setup(m, { expose: l }) {
      return l({ frontmatter: {} }), (a, u) => (i(), c('div', ct, ht))
    }
  },
  vt = { class: 'coco-markdown-body' },
  xt = U(
              ...
              n(
                ...
                { style: { margin: '50px 0' } },
                {
                  default: x(() => [
                    n(
                      f,
                      { direction: 'left', url: '/component/link' },
                      { default: x(() => [yt]), _: 1 }
                    ),
                    n(
                      f,
                      { direction: 'right', url: '/component/menu' },
                      { default: x(() => [$t]), _: 1 }
                    )
                  ]),
                  _: 1
            ...
            [
              ...
              n(
                d,
                {
                  size: 'medium',
                  modelValue: f.value,
                  'onUpdate:modelValue': e[4] || (e[4] = (o) => (f.value = o))
                },
                null,
                8,
                ['modelValue']
              ...
              n(
                d,
                {
                  size: 'small',
                  modelValue: v.value,
                  'onUpdate:modelValue': e[5] || (e[5] = (o) => (v.value = o))
                },
                null,
                8,
                ['modelValue']
              ...
              n(
                d,
                {
                  size: 'mini',
                  modelValue: $.value,
                  'onUpdate:modelValue': e[6] || (e[6] = (o) => ($.value = o))
                },
                null,
                8,
                ['modelValue']
              ),
              _(n(h(Y), null, null, 512), [[p]]),
              n(
                d,
                {
                  modelValue: g.value,
                  'onUpdate:modelValue': e[7] || (e[7] = (o) => (g.value = o)),
                  clear: ''
                },
                null,
                8,
              ...
              _(n(h(lt), null, null, 512), [[p]]),
              n(
                d,
                {
                  modelValue: V.value,
                  'onUpdate:modelValue': e[8] || (e[8] = (o) => (V.value = o)),
                  icon: 'coco-ui-electronics'
                },
                null,
                8,
                ['modelValue']
              ),
              _(n(h(it), null, null, 512), [[p]]),
              n(
                d,
                {
                  modelValue: b.value,
