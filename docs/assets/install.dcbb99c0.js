...
const f = { class: 'coco-markdown-body' },
  g = m(
    `<h1>\u5FEB\u901F\u4E0A\u624B</h1><h2>\u5B89\u88C5</h2><p>\u63A8\u8350\u4F7F\u7528 npm \u7684\u65B9\u5F0F\u5B89\u88C5</p><pre><code class="language-shell">npm i coco-ui2
...
createApp(App).use(CocoButton).use(CocoCard).mount(&#39;#app&#39;)
              ...
              e(
                ...
                { style: { margin: '50px 0' } },
                {
                  default: t(() => [
                    ...
                    e(
                      r,
                      { direction: 'right', url: '/component/color' },
                      { default: t(() => [v]), _: 1 }
                    )
                  ]),
                  _: 1
  ...
  T = {
    setup(c) {
      return (o, i) => {
        const n = _('high')
        return l((s(), d(y(A), null, null, 512)), [[n]])
      }
    }
  }
export { T as default }
