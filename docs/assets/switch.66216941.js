...
const C = { class: 'coco-markdown-body' },
  k = t('h1', null, 'Switch \u5F00\u5173', -1),
  T = t('h2', null, '\u57FA\u672C\u4F7F\u7528', -1),
  U = t('p', null, '\u5F00\u5173\u7684\u57FA\u672C\u4F7F\u7528', -1),
  q = [k, T, U],
  B = {
    setup(i, { expose: l }) {
      return l({ frontmatter: {} }), (s, r) => (c(), _('div', C, q))
    }
  },
...
`
  ...
  A = {
    setup(i, { expose: l }) {
      return l({ frontmatter: {} }), (s, r) => (c(), _('div', N, j))
    }
  },
  P = { class: 'coco-markdown-body' },
  Q = t(
    'pre',
    null,
    [
...
`
  ...
  I = {
    setup(i, { expose: l }) {
      return l({ frontmatter: {} }), (s, r) => (c(), _('div', P, H))
    }
  },
...
`
  ...
  W = {
    setup(i, { expose: l }) {
      return l({ frontmatter: {} }), (s, r) => (c(), _('div', J, R))
    }
  },
  X = { class: 'coco-markdown-body' },
  Y = t(
    'pre',
    null,
    [
...
`
  ...
  lt = {
    setup(i, { expose: l }) {
      return l({ frontmatter: {} }), (s, r) => (c(), _('div', X, et))
    }
  },
              ...
              e(
                ...
                { style: { margin: '50px 0' } },
                {
                  default: $(() => [
                    e(
                      v,
                      { direction: 'left', url: '/component/table' },
                      { default: $(() => [dt]), _: 1 }
                    ),
                    e(
                      v,
                      { direction: 'right', url: '/component/calendar' },
                      { default: $(() => [st]), _: 1 }
                    )
                  ]),
                  _: 1
        ...
        return (
          ...
          _(
            ...
            [
              ...
              m(e(p(A), null, null, 512), [[h]]),
              e(
                a,
                {
                  modelValue: d.value,
                  'onUpdate:modelValue': o[2] || (o[2] = (n) => (d.value = n)),
                  closeText: '\u5173\u95ED',
                  openText: '\u5F00\u542F'
                },
                null,
              ...
              m(e(p(I), null, null, 512), [[h]]),
              e(
                a,
                {
                  modelValue: s.value,
                  'onUpdate:modelValue': o[3] || (o[3] = (n) => (s.value = n)),
                  disabled: ''
                },
                null,
                8,
              ...
              e(
                ...
                {
                  modelValue: r.value,
                  'onUpdate:modelValue': o[4] || (o[4] = (n) => (r.value = n)),
                  disabled: ''
                },
                null,
                8,
              ...
              m(e(p(W), null, null, 512), [[h]]),
              e(
                a,
                {
                  modelValue: v.value,
                  'onUpdate:modelValue': o[5] || (o[5] = (n) => (v.value = n)),
                  closeColor: 'red',
                  openColor: 'green'
                },
                null,
              ...
              m(e(p(lt), null, null, 512), [[h]]),
              e(
                a,
                {
                  modelValue: g.value,
                  'onUpdate:modelValue': o[7] || (o[7] = (n) => (g.value = n)),
                  width: 60
                },
                null,
                8,
