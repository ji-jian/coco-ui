...
const x = { class: 'coco-markdown-body' },
  C = n('h1', null, 'Drawer \u62BD\u5C49', -1),
  U = n('h2', null, '\u57FA\u672C\u4F7F\u7528', -1),
  z = n('p', null, '\u62BD\u5C49\u7684\u57FA\u672C\u4F7F\u7528', -1),
  B = n(
    'p',
    null,
    'title \u5C5E\u6027\u53EF\u4EE5\u914D\u7F6E\u62BD\u5C49\u7684\u6807\u9898',
  ...
  H = {
    setup(m, { expose: d }) {
      return d({ frontmatter: {} }), (s, i) => (p(), c('div', x, D))
    }
  },
...
`
  ...
  I = {
    setup(m, { expose: d }) {
      return d({ frontmatter: {} }), (s, i) => (p(), c('div', E, A))
    }
  },
...
`
  ...
  K = {
    setup(m, { expose: d }) {
      return d({ frontmatter: {} }), (s, i) => (p(), c('div', O, J))
    }
  },
...
&lt;/script&gt;
              ...
              o(
                ...
                { style: { margin: '50px 0' } },
                {
                  default: l(() => [
                    o(
                      u,
                      { direction: 'left', url: '/component/notification' },
                      { default: l(() => [R]), _: 1 }
                    ),
                    o(
                      u,
                      { direction: 'right', url: '/component/dialog' },
                      { default: l(() => [W]), _: 1 }
                    )
                  ]),
                  _: 1
  ...
  et = r('\u4ECE\u4E0B\u9762\u5F39\u51FA'),
  ot = r('\u4ECE\u4E0A\u9762\u5F39\u51FA'),
  dt = r(' hello\uFF0C\u6B22\u8FCE\u4F7F\u7528 coco-ui! '),
  lt = r('\u70B9\u6211\u6253\u5F00'),
  nt = r(' hello\uFF0C\u6B22\u8FCE\u4F7F\u7528 coco-ui! '),
  rt = r('\u70B9\u6211\u6253\u5F00'),
  at = r('\u70B9\u6211\u6253\u5F00\u5185\u5C42'),
  st = r(' hello\uFF0C\u6B22\u8FCE\u4F7F\u7528 coco-ui! '),
  it = r(' \u8FD9\u662F\u5185\u5C42\u7684 '),
  ht = {
    setup(m) {
      const d = h('right'),
      ...
      return (V, t) => {
        ...
        return (
          ...
          c(
            ...
            null,
            [
              g(o($(H), null, null, 512), [[b]]),
              o(
                y,
                {
                  type: 'primary',
                  onClick: t[0] || (t[0] = (e) => (a.value = !0))
                },
                { default: l(() => [Y]), _: 1 }
              ),
              o(
              ...
              o(
                ...
                {
                  modelValue: d.value,
                  'onUpdate:modelValue': t[3] || (t[3] = (e) => (d.value = e)),
                  label: 'bottom'
                },
                { default: l(() => [et]), _: 1 },
                8,
              ...
              o(
                ...
                {
                  modelValue: a.value,
                  'onUpdate:modelValue': t[5] || (t[5] = (e) => (a.value = e)),
                  direction: d.value,
                  title: '\u8FD9\u662F\u6807\u9898'
                },
                { default: l(() => [dt]), _: 1 },
              ...
              g(o($(I), null, null, 512), [[b]]),
              o(
                y,
                {
                  type: 'primary',
                  onClick: t[6] || (t[6] = (e) => (s.value = !0))
                },
                { default: l(() => [lt]), _: 1 }
              ),
              o(
              ...
              g(o($(K), null, null, 512), [[b]]),
              o(
                y,
                {
                  type: 'primary',
                  onClick: t[8] || (t[8] = (e) => (i.value = !0))
                },
                { default: l(() => [rt]), _: 1 }
              ),
              o(
