...
const w = { class: 'coco-markdown-body' },
  x = d('h1', null, 'Dialog \u5BF9\u8BDD\u6846', -1),
  V = d('h2', null, '\u57FA\u672C\u4F7F\u7528', -1),
  C = d('p', null, '\u62BD\u5C49\u7684\u57FA\u672C\u4F7F\u7528', -1),
  B = d(
    'p',
    null,
    'title \u5C5E\u6027\u53EF\u4EE5\u914D\u7F6E\u62BD\u5C49\u7684\u6807\u9898',
  ...
  N = {
    setup(_, { expose: s }) {
      return s({ frontmatter: {} }), (i, u) => (h(), p('div', w, H))
    }
  },
...
`
  ...
  j = {
    setup(_, { expose: s }) {
      return s({ frontmatter: {} }), (i, u) => (h(), p('div', U, T))
    }
  },
...
`
  ...
  J = {
    setup(_, { expose: s }) {
      return s({ frontmatter: {} }), (i, u) => (h(), p('div', A, G))
    }
  },
              ...
              e(
                ...
                { style: { margin: '50px 0' } },
                {
                  default: o(() => [
                    e(
                      v,
                      { direction: 'left', url: '/component/drawer' },
                      { default: o(() => [M]), _: 1 }
                    )
                  ]),
                  _: 1
      ...
      return (v, t) => {
        ...
        return (
          ...
          p(
            ...
            null,
            [
              f(e(g(N), null, null, 512), [[m]]),
              e(
                a,
                { simple: '', onClick: t[0] || (t[0] = (n) => (s.value = !0)) },
                { default: o(() => [W]), _: 1 }
              ),
              e(
                c,
              ...
              f(e(g(j), null, null, 512), [[m]]),
              e(
                a,
                { simple: '', onClick: t[3] || (t[3] = (n) => (r.value = !0)) },
                { default: o(() => [tt]), _: 1 }
              ),
              e(
                c,
                {
                  modelValue: r.value,
                  'onUpdate:modelValue': t[5] || (t[5] = (n) => (r.value = n)),
                  title: '\u8FD9\u662F\u6807\u9898',
                  showHeader: !1
                },
                {
              ...
              e(
                a,
                { simple: '', onClick: t[6] || (t[6] = (n) => (i.value = !0)) },
                { default: o(() => [nt]), _: 1 }
              ),
              e(
                c,
                {
                  modelValue: i.value,
                  'onUpdate:modelValue': t[9] || (t[9] = (n) => (i.value = n)),
                  title: '\u8FD9\u662F\u6807\u9898',
                  width: '50%'
                },
                {
