...
const $ = { class: 'coco-markdown-body' },
  b = t('h1', null, 'List \u5217\u8868', -1),
  k = t('h2', null, '\u57FA\u672C\u4F7F\u7528', -1),
  v = t('p', null, '\u5217\u8868\u7684\u57FA\u672C\u4F7F\u7528', -1),
  w = t(
    'p',
    null,
  ...
  B = {
    setup(d, { expose: e }) {
      return e({ frontmatter: {} }), (l, a) => (r(), s('div', $, S))
    }
  },
...
`
  ...
  C = t('h2', null, '\u914D\u7F6E\u8868\u5934\u548C\u9875\u811A', -1),
  N = t('p', null, 'header \u8868\u5934\u5185\u5BB9', -1),
  V = t('p', null, 'footer \u9875\u811A\u5185\u5BB9', -1),
  D = [z, C, N, V],
  F = {
    setup(d, { expose: e }) {
      return e({ frontmatter: {} }), (l, a) => (r(), s('div', q, D))
    }
  },
...
`
  ...
  E = t('h2', null, '\u6591\u9A6C\u7EB9', -1),
  H = t('p', null, 'zebra \u662F\u5426\u663E\u793A\u6591\u9A6C\u7EB9', -1),
  L = t('p', null, 'num \u662F\u5426\u663E\u793A\u5E8F\u53F7', -1),
  P = [A, E, H, L],
  Q = {
    setup(d, { expose: e }) {
      return e({ frontmatter: {} }), (l, a) => (r(), s('div', j, P))
    }
  },
...
`
  ...
  M = {
    setup(d, { expose: e }) {
      return e({ frontmatter: {} }), (l, a) => (r(), s('div', T, K))
    }
  },
              ...
              n(
                ...
                { style: { margin: '50px 0' } },
                {
                  default: m(() => [
                    n(
                      o,
                      { direction: 'left', url: '/component/button' },
                      { default: m(() => [U]), _: 1 }
                    ),
                    n(
                      o,
                      { direction: 'right', url: '/component/card' },
                      { default: m(() => [W]), _: 1 }
                    )
                  ]),
                  _: 1
      ...
      return (c, l) => {
        ...
        return (
          ...
          s(
            ...
            null,
            [
              _(n(h(B), null, null, 512), [[o]]),
              n(a, { content: e, keys: 'name' }),
              _(n(h(F), null, null, 512), [[o]]),
              n(a, {
                content: e,
                keys: 'name',
                header: '\u8FD9\u662F\u5934\u90E8',
              ...
              _(n(h(M), null, null, 512), [[o]]),
              n(a, { hoverShow: '', content: e, keys: 'name' }),
              _(n(h(X), null, null, 512), [[o]])
            ],
            64
          )
        )
