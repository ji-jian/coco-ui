...
import { c as F, m as I } from './tips.f775595e.js'
const P = {
    title: String,
    message: String,
    time: { type: Number, default: () => 3500 },
    position: {
      type: String,
      default: () => 'top-right',
      validator(s) {
    ...
    type: {
      type: String,
      validator(s) {
        return ['primary', 'success', 'danger', 'warning', ''].includes(s)
      }
    }
  },
  z = { class: 'coco-notification-body' },
  L = { class: 'coco-notification-content' },
  O = { class: 'coco-notification-title' },
  Q = { class: 'coco-notification-message' },
  G = x({
    props: P,
    setup(s) {
      const e = s,
      ...
      const d = () => {
        ...
        _ = N(() => {
          ...
          switch (e.type) {
            case 'primary':
              ...
              break
            case 'success':
              o = 'coco-ui-success-filling'
              break
            case 'danger':
              o = 'coco-ui-error'
              break
            case 'warning':
              o = 'coco-ui-warning-filling'
              break
          }
          return o
        }),
        f = N(() => [
          ...
          _.value,
          `coco-notification-icon-${e.type}`
        ]),
        b = D(),
        $ = () => {
          var o
          ;(o = b.vnode.el.parentElement) == null || o.removeChild(b.vnode.el)
        }
      return (o, v) => (
        u(),
        T(
          V,
          { name: 'coco-notification-fade', onAfterLeave: $, appear: '' },
          {
            default: i(() => [
              m(
                t(
                  'div',
                  {
                    class: C([
                      'coco-notification',
                      `coco-notification-${o.position}`
                    ])
                  },
                  [
                    t('div', z, [
                      o.type
                        ? (u(), h('i', { key: 0, class: C(y(f)) }, null, 2))
                        : w('', !0),
                      t('div', L, [
                        t('h3', O, S(o.title), 1),
                        t('div', Q, [t('p', null, S(o.message), 1)])
                      ]),
                      o.close
                        ? (u(),
                          h('i', {
  ...
  H = { time: 3500, position: 'top-right', close: !0 },
  r = (s) => F(G, I(H, s)),
  J = { class: 'coco-markdown-body' },
  K = t('h1', null, 'Notification \u901A\u77E5', -1),
  M = t('h2', null, '\u4F7F\u7528\u524D', -1),
  R = t(
    'p',
    null,
...
`
  ...
  nt = [K, M, R, U, W, X, Y, Z, tt],
  et = {
    setup(s, { expose: e }) {
      return e({ frontmatter: {} }), (p, d) => (u(), h('div', J, nt))
    }
  },
...
`
  ...
  rt = {
    setup(s, { expose: e }) {
      return e({ frontmatter: {} }), (p, d) => (u(), h('div', ot, at))
    }
  },
...
`
  ...
  _t = {
    setup(s, { expose: e }) {
      return e({ frontmatter: {} }), (p, d) => (u(), h('div', lt, ht))
    }
  },
...
`
  ...
  $t = {
    setup(s, { expose: e }) {
      return e({ frontmatter: {} }), (p, d) => (u(), h('div', mt, bt))
    }
  },
  kt = { class: 'coco-markdown-body' },
  vt = j(
              ...
              n(
                ...
                { style: { margin: '50px 0' } },
                {
                  default: i(() => [
                    n(
                      _,
                      { direction: 'left', url: '/component/tagging' },
                      { default: i(() => [Nt]), _: 1 }
                    ),
                    n(
                      _,
                      { direction: 'right', url: '/component/drawer' },
                      { default: i(() => [Ct]), _: 1 }
                    )
                  ]),
                  _: 1
      ...
      return (Ft, It) => {
        ...
        return (
          ...
          h(
            ...
            null,
            [
              m(n(y(et), null, null, 512), [[g]]),
              n(
                a,
                { type: 'primary', onClick: e },
                { default: i(() => [St]), _: 1 }
              ),
              m(n(y(rt), null, null, 512), [[g]]),
              n(
                a,
              ...
              n(
                a,
                { type: 'danger', onClick: d },
                { default: i(() => [Tt]), _: 1 }
              ),
              n(
                a,
                { type: 'warning', onClick: _ },
                { default: i(() => [qt]), _: 1 }
              ),
              m(n(y(_t), null, null, 512), [[g]]),
              n(
                a,
              ...
              m(n(y($t), null, null, 512), [[g]]),
              n(
                a,
                { type: 'primary', onClick: v },
                { default: i(() => [Et]), _: 1 }
              ),
              m(n(y(wt), null, null, 512), [[g]])
            ],
            64
          )
        )
