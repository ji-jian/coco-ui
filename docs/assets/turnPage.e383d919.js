...
const f = { class: 'coco-markdown-body' },
  b = n('h1', null, 'TurnPage \u7FFB\u9875', -1),
  q = n('h2', null, '\u57FA\u672C\u4F7F\u7528', -1),
  x = n('p', null, '\u7FFB\u9875\u7684\u57FA\u7840\u7528\u6CD5', -1),
  k = n(
    'p',
    null,
...
`
  ...
  E = r(' \u4E0B\u4E00\u9875 '),
  Q = _(
    `<pre><code class="language-html">&lt;coco-turn-page&gt;
...
&lt;/coco-turn-page&gt;
              ...
              t(
                ...
                { style: { margin: '50px 0' } },
                {
                  default: e(() => [
                    ...
                    t(
                      o,
                      { direction: 'right', url: '/component/backtop' },
                      { default: e(() => [$]), _: 1 }
                    )
                  ]),
                  _: 1
  ...
  H = {
    setup(a) {
      return (i, c) => {
        const h = g('high')
        return p((l(), y(m(z), null, null, 512)), [[h]])
      }
    }
  }
export { H as default }
