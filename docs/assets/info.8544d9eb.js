...
const w = { class: 'coco-markdown-body' },
  k = t('h1', null, 'Info \u4FE1\u606F\u680F', -1),
  q = t('h2', null, '\u57FA\u672C\u4F7F\u7528', -1),
  z = t('p', null, 'Info \u7684\u57FA\u672C\u4F7F\u7528', -1),
  I = t(
    'p',
    null,
    'userInfo \u5C5E\u6027\u53EF\u4EE5\u914D\u7F6E\u6635\u79F0',
...
`
  ...
  $ = f(
    `<pre><code class="language-html">&lt;coco-info
  userInfo=&quot;Coco2001&quot;
...
&lt;/coco-info&gt;
  ...
  J = {
    setup(u, { expose: a }) {
      return (
        a({ frontmatter: {} }),
        (i, K) => {
          const h = n('coco-avatar'),
            d = n('coco-button'),
            r = n('coco-info'),
            l = n('coco-text'),
            y = n('coco-image'),
            c = n('coco-turn-page-item'),
            m = n('coco-turn-page')
          return (
            p(),
            g('div', w, [
              ...
              e(
                r,
                { userInfo: 'Coco2001', describe: 'hello world' },
                {
                  photo: o(() => [
                    e(h, {
                      round: '',
              ...
              e(
                ...
                { userInfo: 'Coco2001', describe: 'hello world' },
                {
                  ...
                  footer: o(() => [
                    e(l, { type: 'danger' }, { default: o(() => [P]), _: 1 })
                  ]),
                  _: 1
                }
              ),
              ...
              e(
                ...
                { style: { margin: '50px 0' } },
                {
                  default: o(() => [
                    e(
                      c,
                      { direction: 'left', url: '/component/pageHeader' },
                      { default: o(() => [F]), _: 1 }
                    ),
                    e(
                      c,
                      { direction: 'right', url: '/component/textarea' },
                      { default: o(() => [G]), _: 1 }
                    )
                  ]),
                  _: 1
  ...
  M = {
    setup(u) {
      return (a, _) => {
        const i = b('high')
        return v((p(), x(T(J), null, null, 512)), [[i]])
      }
    }
  }
export { M as default }
