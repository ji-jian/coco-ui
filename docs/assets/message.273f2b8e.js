...
import { M as r } from './index.c18f09c7.js'
import './tips.f775595e.js'
const x = { class: 'coco-markdown-body' },
  C = t('h1', null, 'Message \u63D0\u793A\u6846', -1),
  v = t('h2', null, '\u4F7F\u7528\u524D', -1),
  B = t(
    'p',
    null,
...
`
  ...
  S = {
    setup(h, { expose: n }) {
      return n({ frontmatter: {} }), (d, i) => (u(), l('div', x, F))
    }
  },
...
`
  ...
  z = {
    setup(h, { expose: n }) {
      return n({ frontmatter: {} }), (d, i) => (u(), l('div', T, Q))
    }
  },
...
`
  ...
  L = {
    setup(h, { expose: n }) {
      return n({ frontmatter: {} }), (d, i) => (u(), l('div', G, K))
    }
  },
...
`
  ...
  Y = {
    setup(h, { expose: n }) {
      return n({ frontmatter: {} }), (d, i) => (u(), l('div', O, X))
    }
  },
...
&lt;/script&gt;
              ...
              e(
                ...
                { style: { margin: '50px 0' } },
                {
                  default: s(() => [
                    e(
                      g,
                      { direction: 'left', url: '/component/backtop' },
                      { default: s(() => [et]), _: 1 }
                    ),
                    e(
                      g,
                      { direction: 'right', url: '/component/skeleton' },
                      { default: s(() => [nt]), _: 1 }
                    )
                  ]),
                  _: 1
  ...
  ft = {
    setup(h) {
      function n() {
        r({ message: '\u9ED8\u8BA4\u63D0\u793A', type: 'default', round: !0 })
      }
      function a() {
        r({ message: '\u4E3B\u8981\u63D0\u793A', type: 'primary', round: !0 })
      }
      function d() {
        r({ message: '\u6210\u529F\u63D0\u793A', type: 'success', round: !0 })
      }
      function i() {
        r({ message: '\u5371\u9669\u63D0\u793A', type: 'danger', round: !0 })
      }
      function g() {
        r({ message: '\u8B66\u544A\u63D0\u793A', type: 'warning', round: !0 })
      }
      function y() {
        r({
          message: '5000\u6BEB\u79D2\u540E\u9690\u85CF',
      ...
      return (ht, _t) => {
        ...
        return (
          ...
          l(
            ...
            null,
            [
              p(e(m(S), null, null, 512), [[_]]),
              e(c, { onClick: n }, { default: s(() => [ot]), _: 1 }),
              e(
                c,
              ...
              e(
                c,
                { type: 'danger', onClick: i },
                { default: s(() => [at]), _: 1 }
              ),
              e(
                c,
                { type: 'warning', onClick: g },
                { default: s(() => [dt]), _: 1 }
              ),
              p(e(m(z), null, null, 512), [[_]]),
              e(
                c,
                { type: 'primary', onClick: y },
                { default: s(() => [it]), _: 1 }
              ),
              p(e(m(L), null, null, 512), [[_]]),
              e(
                c,
                { type: 'primary', onClick: b },
                { default: s(() => [ut]), _: 1 }
              ),
              p(e(m(Y), null, null, 512), [[_]]),
              e(
                c,
                { type: 'primary', onClick: $ },
                { default: s(() => [lt]), _: 1 }
              ),
              p(e(m(st), null, null, 512), [[_]])
            ],
            64
          )
        )
